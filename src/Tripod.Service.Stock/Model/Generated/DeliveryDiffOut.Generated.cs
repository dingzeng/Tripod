...
{
	[Table("delivery_diff_out")]
	public partial class DeliveryDiffOut : Entity
	{
		/// <summary>
		/// 单据号
		/// <summary>
		...
		/// 引用配送单号
		/// <summary>
		public string RefDeliverySheetId { get; set; }

		/// <summary>
		/// 引用配送差异申请单
		/// <summary>
		public string RefDeliveryDiffApplySheetId { get; set; }
